...
ptasim_inp_template = ptasim_inp_template_f.read()
...
for alpha_upper, alpha_lower, p0_upper, p0_lower in zip(alpha_uppers, alpha_lowers, p0_uppers, p0_lowers):
...
with open('psr_noise_vals3.dat', 'w') as psr_datf:
