...
spec_files = sorted(glob.glob('all_common_regsamp/timfiles/J[012]*.spec'))


fig, (ax1,ax2) = plt.subplots(2,1,figsize=(7,12))#, xscale = 'log', yscale = 'log')

plt.sca(ax1)
ax1.set_title('All pulsars with common noise')
...
ax2.legend()
fig.tight_layout()
plt.savefig('cholspec_both.png', dpi = 300, bbox_inches = 'tight')
plt.show()
