#!/bin/bash
#SBATCH --job-name=ppta_ptasim_26psr_similar_pe_spin
#SBATCH --output=/flush5/zic006/pptadr2_gwb_crn_sims/ptasim_26psr_similar/slurm_logs/ppta_ptasim_26psr_similar_pe_spin_20210524_%A_%a.log
#SBATCH --ntasks=4
