#!/bin/bash
#SBATCH --job-name=ppta_ptasim_26psr_similar_mc_spin_v_spincommon_logweights_400_1
#SBATCH --output=/flush5/zic006/pptadr2_gwb_crn_sims/ptasim_26psr_similar/slurm_logs/ppta_ptasim_26psr_similar_mc_spin_v_spincommon_logweights_400_1_20210524_%A_%a.log
#SBATCH --ntasks=8
